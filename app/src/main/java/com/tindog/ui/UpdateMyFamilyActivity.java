...
public class UpdateMyFamilyActivity extends AppCompatActivity implements FirebaseDao.FirebaseOperationsHandler, ImagesRecycleViewAdapter.ImageClickHandler, AdapterView.OnItemSelectedListener {
    ...
    @BindView(R.id.update_my_family_value_state) TextInputEditText mEditTextState;
        ...
        switch (itemThatWasClickedId) {
            ...
            case R.id.action_save:
                ...
                if (mFamilyCriticalParametersSet) {
                    if (!TextUtils.isEmpty(mFirebaseUid)) mFirebaseDao.updateObjectOrCreateItInFirebaseDb(mFamily, true);
                }
                return true;
    ...
    private void getFamilyProfileFromFirebase() {
        if (mCurrentFirebaseUser != null) {
            ...
            if (!mFamilyFound) mFirebaseDao.getUniqueObjectFromFirebaseDbOrCreateIt(mFamily, true);
        }
    }
